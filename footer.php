...
?>
        ...
        <footer id="footer" class="site-footer" role="contentinfo">
            ...
            <div class="site-info">
                ...
                <a href="https://wordpress.org/" rel="generator"><?php printf( esc_html__( 'Proudly powered by %s', 'sugarspice' ), 'WordPress' ); ?></a>
                <span class="sep"> | </span>
                <?php printf( wp_kses_post( __( 'Theme: %1$s by %2$s.', 'sugarspice' ) ), 'Sugar &amp; Spice', '<a href="https://webtuts.pl" rel="designer noopener noreferrer">WebTuts</a>' ); ?>
            </div><!-- .site-info -->
        </footer>
