...
$archive_layout = sugarspice_get_layout_option( 'ap_layout', 'excerpt' );
?>
						...
						elseif ( is_author() ) :
							...
							*/
							...
							printf(
								...
								esc_html__( 'Author: %s', 'sugarspice' ),
