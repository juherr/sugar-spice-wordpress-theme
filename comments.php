...
?>
	...
	<?php if ( have_comments() ) : ?>
		...
		<nav id="comment-nav-above" class="comment-navigation" role="navigation">
			...
			<div class="nav-previous"><?php previous_comments_link( esc_html__( '&larr; Older Comments', 'sugarspice' ) ); ?></div>
			<div class="nav-next"><?php next_comments_link( esc_html__( 'Newer Comments &rarr;', 'sugarspice' ) ); ?></div>
